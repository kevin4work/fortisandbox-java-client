...
public class JsonRpcClient {
	...
	public <T> T invokeAndReadResponse(String session, String methodName, Object argument, Class<T> clazz, OutputStream output, InputStream input) throws Throwable {
		return (T) invokeAndReadResponse(session, methodName, argument, Type.class.cast(clazz), output, input);
	}
	 ...
	 * @see #writeRequest(String, Object, OutputStream, String)
	 */
	public Object invokeAndReadResponse(String session, String methodName, Object argument, Type returnType, OutputStream output, InputStream input) throws Throwable {
		return invokeAndReadResponse(session, methodName, argument, returnType, output, input, this.requestIDGenerator.generateID());
	}
	 ...
	 * @see #writeRequest(String, Object, OutputStream, String)
	 */
	private Object invokeAndReadResponse(String session, String methodName, Object argument, Type returnType, OutputStream output, InputStream input, String id) throws Throwable {
		invoke(session, methodName, argument, output, id);
	 ...
	 * @see #writeRequest(String, Object, OutputStream, String)
	 */
	private void invoke(String session, String methodName, Object argument, OutputStream output, String id) throws IOException {
		writeRequest(session, methodName, argument, output, id);
		output.flush();
	}
	...
	private Object readResponse(Type returnType, InputStream input, String id) throws Throwable {
		...
		if (hasResult(jsonObject)) {
			...
			if (hasSession(jsonObject)){
			    return constructSessionResponseObject(returnType, jsonObject);
			}
	 ...
	 * @throws IOException on error
	 */
	private void writeRequest(String session, String methodName, Object argument, OutputStream output, String id) throws IOException {
		internalWriteRequest(session, methodName, argument, output, id);
	}
	...
	private boolean hasSession(ObjectNode jsonObject) {
		return hasNonNullData(jsonObject, "session");
	}
	...
	private boolean isSessionReturned(Type returnType) {
		if (returnType == null || returnType == Void.class) {
			logger.warn("Server returned result but returnType is null");
			return true;
		}
	...
	private Object constructSessionResponseObject(Type returnType, ObjectNode jsonObject) throws IOException {
	 ...
	 * @throws IOException on error
	 */
	private void internalWriteRequest(String session, String methodName, Object arguments, OutputStream output, String id) throws IOException {
		final ObjectNode request = internalCreateRequest(session, methodName, arguments, id);
	 ...
	 */
	private ObjectNode internalCreateRequest(String session, String methodName, Object arguments, String id) {
		final ObjectNode request = mapper.createObjectNode();
		addId(id, request);
		addSession(session, request);
	...
	private void addSession(String session, ObjectNode request) {
		if (session != null) {
	...
	private boolean hasNonNullObjectData(final ObjectNode node, final String key) {
	...
	private boolean hasNonNullTextualData(final ObjectNode node, final String key) {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public <T> T invokeAndReadResponse(String session, String methodName, Object argument, Class<T> clazz, OutputStream output, InputStream input, String id) throws Throwable {
		return (T) invokeAndReadResponse(session, methodName, argument, Type.class.cast(clazz), output, input, id);
	}
	 ...
	 * @see #writeRequest(String, Object, OutputStream, String)
	 */
	public void invoke(String session, String methodName, Object argument, OutputStream output) throws IOException {
		invoke(session, methodName, argument, output, this.requestIDGenerator.generateID());
	}
	 ...
	 * @see #writeRequest(String, Object, OutputStream, String)
	 */
	public void invokeNotification(String session, String methodName, Object argument, OutputStream output) throws IOException {
		writeRequest(session, methodName, argument, output, null);
		output.flush();
	}
	...
	protected ObjectNode createRequest(String methodName, Object argument) {
		return internalCreateRequest(null, methodName, argument, this.requestIDGenerator.generateID());
	}
	
	public ObjectNode createRequest(String methodName, Object argument, String id) {
		return internalCreateRequest(null, methodName, argument, id);
	}
	
	protected ObjectNode createRequest(String session, String methodName, Object argument) {
		return internalCreateRequest(session, methodName, argument, this.requestIDGenerator.generateID());
	}
	
	public ObjectNode createRequest(String session, String methodName, Object argument, String id) {
		return internalCreateRequest(session, methodName, argument, id);
	}
	...
	public void writeNotification(String session, String methodName, Object argument, OutputStream output) throws IOException {
		internalWriteRequest(session, methodName, argument, output, null);
	}
